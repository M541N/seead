...
extension $AdCampaignExtension on AdCampaign {
  ...
  AdCampaign copyWithWrapped({
    ...
    return AdCampaign(
      ...
      targetGender:
          (targetGender != null ? targetGender.value : this.targetGender),
      targetAgeMin:
          (targetAgeMin != null ? targetAgeMin.value : this.targetAgeMin),
      targetAgeMax:
          (targetAgeMax != null ? targetAgeMax.value : this.targetAgeMax),
      seeadPerView:
          (seeadPerView != null ? seeadPerView.value : this.seeadPerView),
      ...
      targetInterests:
          (targetInterests != null
              ...
              : this.targetInterests),
      targetRegions:
          (targetRegions != null ? targetRegions.value : this.targetRegions),
    );
  }
}
...
extension $AdMediaExtension on AdMedia {
  ...
  AdMedia copyWithWrapped({
    ...
    return AdMedia(
      ...
      thumbnailImg:
          (thumbnailImg != null ? thumbnailImg.value : this.thumbnailImg),
      videoFile: (videoFile != null ? videoFile.value : this.videoFile),
      videoDuration:
          (videoDuration != null ? videoDuration.value : this.videoDuration),
    );
  }
}
...
extension $AdvertiserDetailExtension on AdvertiserDetail {
  ...
  AdvertiserDetail copyWithWrapped({
    ...
    return AdvertiserDetail(
      ...
      businessInfo:
          (businessInfo != null ? businessInfo.value : this.businessInfo),
      outsourcingCompanies:
          (outsourcingCompanies != null
...
extension $BusinessInfoExtension on BusinessInfo {
  ...
  BusinessInfo copyWithWrapped({
    ...
    return BusinessInfo(
      ...
      companyNameEn:
          (companyNameEn != null ? companyNameEn.value : this.companyNameEn),
      homepageUrl: (homepageUrl != null ? homepageUrl.value : this.homepageUrl),
      logoUrl: (logoUrl != null ? logoUrl.value : this.logoUrl),
      representative:
          (representative != null ? representative.value : this.representative),
...
extension $RewardStatusExtension on RewardStatus {
  ...
  RewardStatus copyWithWrapped({
    ...
    return RewardStatus(
      availableSeed:
          (availableSeed != null ? availableSeed.value : this.availableSeed),
      todayClaimed:
          (todayClaimed != null ? todayClaimed.value : this.todayClaimed),
