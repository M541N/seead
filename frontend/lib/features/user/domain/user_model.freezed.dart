...
mixin _$UserModel {
  ...
  String get username =>
      throw _privateConstructorUsedError; // email을 non-null + 기본값 '' 로 유지
  @JsonKey(defaultValue: '')
  String get email => throw _privateConstructorUsedError; // role 기본값 'user'
...
class _$UserModelImpl implements _UserModel {
  const _$UserModelImpl({
    ...
    @JsonKey(defaultValue: 'user') this.role = 'user',
  });
...
abstract class _UserModel implements UserModel {
  ...
  int get id;
  @override
  String get username; // email을 non-null + 기본값 '' 로 유지
  @override
  @JsonKey(defaultValue: '')
  String get email; // role 기본값 'user'
  @override
  @JsonKey(defaultValue: 'user')
  String get role;
