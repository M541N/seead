...
AdvertiserDetail _$AdvertiserDetailFromJson(
  Map<String, dynamic> json,
) => AdvertiserDetail(
  id: (json['id'] as num?)?.toInt(),
  name: json['name'] as String,
  ...
  outsourcingCompanies:
      (json['outsourcing_companies'] as List<dynamic>?)
          ?.map((e) => OutsourcingCompany.fromJson(e as Map<String, dynamic>))
          .toList() ??
      [],
  brands:
...
Map<String, dynamic> _$AdvertiserDetailToJson(AdvertiserDetail instance) =>
    <String, dynamic>{
      ...
      'outsourcing_companies': instance.outsourcingCompanies
          ?.map((e) => e.toJson())
          .toList(),
