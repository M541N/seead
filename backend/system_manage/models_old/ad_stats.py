...
class AdRewardPoint(models.Model):
    ...
    viewer = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="reward_points", on_delete=models.CASCADE)
...
class AdViewLog(models.Model):
    ...
    viewer = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='view_logs', null=True, blank=True)
...
class AdViewer(models.Model):
    ...
    viewer = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="viewers", on_delete=models.CASCADE)
...
class AdLike(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='ad_likes')
